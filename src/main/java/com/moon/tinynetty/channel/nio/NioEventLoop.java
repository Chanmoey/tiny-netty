...
import com.moon.tinynetty.channel.EventLoopTaskQueueFactory;
import com.moon.tinynetty.channel.SelectStrategy;
import com.moon.tinynetty.channel.SingleThreadEventLoop;
...
public class NioEventLoop extends SingleThreadEventLoop {
    ...
    private void processSelectedKey(SelectionKey k) throws Exception {
        ...
        if (socketChannel != null) {
            if (k.isConnectable() && (socketChannel.finishConnect())) {
                //注册读事件
        ...
        if (serverSocketChannel != null) {
            ...
            if (k.isAcceptable()) {
                ...
                logger.info("客户端连接成功:{}", socketChannel);
